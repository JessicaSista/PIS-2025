                ...
                foreach (var joinOperand in joinOperands)
                {
                    ...
                    var join = await _context.CrossModuleJoins
                        ...
                        .FirstOrDefaultAsync(j =>
                            ((j.LeftOperand.DatasetId == joinOperand.DatasetId && j.LeftOperand.ModuleType == ModuleType.InsightMonitor) || (j.RightOperand.DatasetId == joinOperand.DatasetId && j.RightOperand.ModuleType == ModuleType.InsightMonitor)));
